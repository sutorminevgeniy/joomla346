...
function modChrome_html5($module, &$params, &$attribs)
{
	...
	if (!empty ($module->content)) : ?>
		<?php $mouleClass = trim("moduletable " . htmlspecialchars($params->get('moduleclass_sfx')) . $moduleClass); ?>
		<<?php echo $moduleTag; ?> class="<?php echo $mouleClass; ?>">
...
{ ?>
	<?php $mouleClass = trim("moduletable " . htmlspecialchars($params->get('moduleclass_sfx'))); ?>
	<table cellpadding="0" cellspacing="0" class="<?php echo $mouleClass; ?>">
	<?php if ((bool) $module->showtitle) : ?>
		<tr>
			<th>
...
{ ?>
		<?php $mouleClass = trim("module " . htmlspecialchars($params->get('moduleclass_sfx'))); ?>
		<div class="<?php echo $mouleClass; ?>">
			<div>
				<div>
					<div>
						<?php if ((bool) $module->showtitle) : ?>
